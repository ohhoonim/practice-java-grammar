...
public class GathererMain {
    public static void main(String[] args) {
        ...
        var result = findSuspiciousWithGatherers(Reading.loadRecentReadings());
        IO.println(result);
    ...
    static List<List<Reading>> findSuspiciousWithGatherers(Stream<Reading> source) {
